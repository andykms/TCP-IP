...
export type THerculesTextType = "main" | "sub" | "ok" | "warning" | "danger" | "neutral" | "primary"
export type THerculesTextSize = "small" | "medium" | "large";
export type THerculesTextWeight = "bold" | "normal" | "thin";
...
export class HercTextDirective implements OnInit, OnChanges {
  ...
  private setClasses() {
    ...
    this.rerender.setAttribute(this.el.nativeElement, "class", classes.join(" ") + ` ${this.class()}`);
  }
}